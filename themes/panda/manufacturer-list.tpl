	...
	{if $nbManufacturers > 0}
    	<div class="content_sortPagiBar">
        	<div class="sortPagiBar clearfix">
                ...
                {include file="./pagination.tpl" no_follow=1}
            </div>
						...
						<div class="row">
			            	<div class="left-side col-xs-12 col-sm-3 col-md-3">
								<div class="logo">
									...
									{/if}
										<img src="{$img_manu_dir}{$manufacturer.image|escape:'html':'UTF-8'}-medium_default.jpg" class="replace-2x" width="{$mediumSize.width}" height="{$mediumSize.height}" alt="{$manufacturer.name|escape:'html':'UTF-8'}" />
									{if $manufacturer.nb_products > 0}
										</a>
									{/if}
								</div> <!-- .logo -->
