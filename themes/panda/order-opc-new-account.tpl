		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="submit">
					...
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="btn btn-default">{l s='Sign in'}</button>
				</p>
			</div>
		</fieldset>
	</form>
			...
			<div class="box">
				...
				<div id="opc_account_choice" class="row">
					<div class="col-xs-12 col-md-4">
						...
						<p class="opc-button">
							<button type="submit" class="btn btn-default" id="opc_guestCheckout">{l s='Guest checkout'}</button>
						</p>
					</div>
					<div class="col-xs-12 col-md-8">
						...
						<p class="opc-button">
							<button type="submit" class="btn btn-default" id="opc_createAccount">{l s='Create an account'}</button>
						</p>
					</div>
				</div>
				<div id="opc_account_form" class="unvisible">
					...
					<div class="required form-stru gender-line">
					...
					<div class="text {if isset($required_fields) && !in_array($field_name, $required_fields)} is_customer_param{/if} form-group">
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						{elseif $field_name eq "address2"}
						<div class="form-group{if isset($required_fields) && !in_array($field_name, $required_fields)} is_customer_param{/if}">
					...
					<div class="submit opc-add-save clearfix">
						...
						<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default">{l s='Save'}</button>
					</div>
