...
function updatePrice()
{
	...
	if (priceWithDiscountsDisplay.toFixed(2) != basePriceDisplay.toFixed(2))
	{
		...
		if (priceWithDiscountsWithoutTax != priceWithGroupReductionWithoutTax)
		{
			if (combination.specific_price.reduction_type == 'amount')
			{
				$('#reduction_amount_display').html((typeof(discount_percentage)!='undefined' && discount_percentage>1 ? discount_percentage_save+(discount_percentage==2 ? '<br/>' : ' ') : '')+ '-' + formatCurrency(+discountValue * currencyRate, currencyFormat, currencySign, currencyBlank));
