...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
        ...
        "image_width":	 "{getWidthSize type='small_default'}",
        "image_height":	 "{getHeightSize type='small_default'}",
		"image_cart": {$link->getImageLink($product.link_rewrite, $product.id_image, 'small_default')|json_encode},
		...
		"full_name": {$product.name|trim|html_entity_decode:2:'UTF-8'|json_encode},
