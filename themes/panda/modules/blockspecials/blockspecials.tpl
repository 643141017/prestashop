...
<div id="special_block_right" class="block column_block">
    <h3 class="title_block">
        <a href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='All specials' mod='blockspecials'}">
    ...
    {if $special}
        <ul class="pro_column_list">
            <li class="pro_column_box clearfix">
                <a class="pro_column_left products-block-image" href="{$special.link|escape:'html':'UTF-8'}">
                    <img 
                    ...
                    width="{$smarty.capture.small_default_width}" 
                    height="{$smarty.capture.small_default_height}" />
                </a>
    ...
    {else}
        <div class="warning">{l s='No special products at this time.' mod='blockspecials'}</div>
    {/if}
    </div>
</div>
<!-- /MODULE Block specials -->