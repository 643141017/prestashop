<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 18:03:51
         compiled from "D:\WWW\prestashop16110\themes\panda\modules\blockcart\blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:26103586cc8876ebe78-79640773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2290ef23e0fb74e7ca61a3436622639c7ae249df' => 
    array (
      0 => 'D:\\WWW\\prestashop16110\\themes\\panda\\modules\\blockcart\\blockcart-json.tpl',
      1 => 1482908691,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26103586cc8876ebe78-79640773',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586cc887818af1_09620387',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586cc887818af1_09620387')) {function content_586cc887818af1_09620387($_smarty_tpl) {?>
{
"products": [
...
,
		"image": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'small_default'));?>
,
        "image_width":	 "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getWidthSize'][0][0]->getWidth(array('type'=>'small_default'),$_smarty_tpl);?>
",
        "image_height":	 "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHeightSize'][0][0]->getHeight(array('type'=>'small_default'),$_smarty_tpl);?>
",
		"image_cart": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'small_default'));?>
,
...
,
		"full_name": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(html_entity_decode(trim($_smarty_tpl->tpl_vars['product']->value['name']),2,'UTF-8'));?>
,
