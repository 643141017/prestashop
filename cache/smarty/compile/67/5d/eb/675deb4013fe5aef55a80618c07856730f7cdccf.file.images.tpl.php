<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 17:45:15
         compiled from "D:\WWW\prestashop16110\override\controllers\admin\templates\products\images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29113586cc42b156373-64747528%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '675deb4013fe5aef55a80618c07856730f7cdccf' => 
    array (
      0 => 'D:\\WWW\\prestashop16110\\override\\controllers\\admin\\templates\\products\\images.tpl',
      1 => 1483500750,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29113586cc42b156373-64747528',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586cc42b238c76_80395618',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586cc42b238c76_80395618')) {function content_586cc42b238c76_80395618($_smarty_tpl) {?>
...
?>
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['show_hover']->value)&&$_smarty_tpl->tpl_vars['show_hover']->value) {?><th class="fixed-width-xs"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Hover'),$_smarty_tpl);?>
</span></th><?php }?>
				<th></th> <!-- action -->
			</tr>
		</thead>
...
" />
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['show_hover']->value)&&$_smarty_tpl->tpl_vars['show_hover']->value) {?>
            <td class="hover">
				<a href="#">
					<i class="icon-square-o icon-2x hover"></i>
				</a>
			</td>
            <?php }?>
			<td>
...
;
		...
		function imageLine(id, path, position, cover, shops, legend, hover)
		{
            ...
            line = line.replace(/icon-square-o/g, hover);
...
","<?php if ($_smarty_tpl->tpl_vars['image']->value->hover) {?>icon-check-square<?php } else { ?>icon-square-o<?php }?>");
			<?php } ?>
...
",
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['show_hover']->value)&&$_smarty_tpl->tpl_vars['show_hover']->value) {?>
            $('i.hover').die().live('click', function(e)
			{
				e.preventDefault();
                $_this = $(this);
				id = $_this.parent().parent().parent().attr('id');
				$("#imageList .hover i").each( function(i){
					$(this).removeClass('icon-check-square').addClass('icon-square-o');
				});
				$_this.removeClass('icon-square-o').addClass('icon-check-square');
                if (current_shop_id != 0)
                    $('#'+current_shop_id+id).attr('check', true);
                else
                    $_this.parent().parent().parent().children('td input').attr('check', true);
                $.ajax({
                    url: '<?php echo $_smarty_tpl->tpl_vars['ajax_link_hover']->value;?>
',
                    type: 'get',
                    dataType: 'json',
                    data: {
                    ...
                    success: function(data) {
                        if (data.r){
                            if (data.r == '-1')
                                $_this.removeClass('icon-check-square').addClass('icon-square-o');
                            showSuccessMessage(data.m);
                        }
                    }
                });
			});
