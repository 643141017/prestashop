<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 17:58:25
         compiled from "D:\WWW\prestashop16110\modules\blockcart_mod\views\templates\hook\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15970586cc7414210f6-47067619%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf4557aa2b07c1985054e57e6fbe2969303660e8' => 
    array (
      0 => 'D:\\WWW\\prestashop16110\\modules\\blockcart_mod\\views\\templates\\hook\\blockcart.tpl',
      1 => 1482908691,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15970586cc7414210f6-47067619',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586cc74169dc72_25304243',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586cc74169dc72_25304243')) {function content_586cc74169dc72_25304243($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\WWW\\prestashop16110\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'D:\\WWW\\prestashop16110\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
	<div class="shopping_cart <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?> top_bar_item <?php if ($_smarty_tpl->tpl_vars['block_cart_style']->value) {?> shopping_cart_style_1 <?php }?> hidden-sm hidden-xs">
...
" id="shopping_cart" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart','mod'=>'blockcart_mod'),$_smarty_tpl);?>
" rel="nofollow" class="header_item">
			...
			<span class="cart_text"><?php echo smartyTranslate(array('s'=>'Shopping cart','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
			<span class="ajax_cart_quantity"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
			<span class="ajax_cart_product_txt"><?php echo smartyTranslate(array('s'=>'item(s)','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
			<span class="ajax_cart_split"><?php echo smartyTranslate(array('s'=>'-','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
		...
		<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['hover_display_cp']->value) {?>
...
<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['addtocart_animation']->value==1&&$_smarty_tpl->tpl_vars['active_overlay']->value==1) {?>
	<div id="layer_cart" class="layer_box">
		<div class="layer_inner_box">
			<div class="layer_product clearfix mar_b10">
				<span class="cross" title="<?php echo smartyTranslate(array('s'=>'Close window','mod'=>'blockcart_mod'),$_smarty_tpl);?>
"></span>
				...
				<div class="layer_product_info">
					...
					<div id="layer_cart_product_quantity_wrap">
						<span class="layer_cart_label"><?php echo smartyTranslate(array('s'=>'Quantity','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
						<span id="layer_cart_product_quantity"></span>
					</div>
					<div id="layer_cart_product_price_wrap">
						<span class="layer_cart_label"><?php echo smartyTranslate(array('s'=>'Total','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
						<span id="layer_cart_product_price"></span>
					</div>
				</div>
			</div>
			<div id="pro_added_success" class="success"><?php echo smartyTranslate(array('s'=>'Product successfully added to your shopping cart','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</div>
			<div class="layer_details">
				<div class="layer_cart_sum">
					<!-- Plural Case [both cases are needed because page may be updated in Javascript] -->
					<span class="ajax_cart_product_txt_s <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>">
						<?php echo smartyTranslate(array('s'=>'There are [1]%d[/1] products in your cart.','mod'=>'blockcart_mod','sprintf'=>array($_smarty_tpl->tpl_vars['cart_qties']->value),'tags'=>array('<span class="ajax_cart_quantity">')),$_smarty_tpl);?>

					</span>
					<!-- Singular Case [both cases are needed because page may be updated in Javascript] -->
					<span class="ajax_cart_product_txt <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>1) {?> unvisible<?php }?>">
						<?php echo smartyTranslate(array('s'=>'There is 1 product in your cart.','mod'=>'blockcart_mod'),$_smarty_tpl);?>

					</span>
				</div>
				<div id="layer_cart_ajax_block_products_total" class="layer_cart_row">
					<span class="layer_cart_label">
						<?php echo smartyTranslate(array('s'=>'Total products','mod'=>'blockcart_mod'),$_smarty_tpl);?>

						<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?>
							<?php echo smartyTranslate(array('s'=>'(tax excl.)','mod'=>'blockcart_mod'),$_smarty_tpl);?>

						<?php } else { ?>
							<?php echo smartyTranslate(array('s'=>'(tax incl.)','mod'=>'blockcart_mod'),$_smarty_tpl);?>
				...
				<div id="layer_cart_ajax_cart_shipping_cost" class="layer_cart_row hidden">
					<span class="layer_cart_label<?php if ($_smarty_tpl->tpl_vars['shipping_cost_float']->value==0&&(!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?> unvisible<?php }?>">
						<?php echo smartyTranslate(array('s'=>'Total shipping','mod'=>'blockcart_mod'),$_smarty_tpl);?>
&nbsp;<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?><?php echo smartyTranslate(array('s'=>'(tax excl.)','mod'=>'blockcart_mod'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'(tax incl.)','mod'=>'blockcart_mod'),$_smarty_tpl);?>
<?php }?>
					</span>
					<span class="ajax_cart_shipping_cost<?php if ($_smarty_tpl->tpl_vars['shipping_cost_float']->value==0&&(!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?> unvisible<?php }?>">
						<?php if ($_smarty_tpl->tpl_vars['shipping_cost_float']->value==0) {?>
							<?php if ((!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?><?php echo smartyTranslate(array('s'=>'To be determined','mod'=>'blockcart_mod'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Free shipping!','mod'=>'blockcart_mod'),$_smarty_tpl);?>
<?php }?>
						<?php } else { ?>
							<?php echo $_smarty_tpl->tpl_vars['shipping_cost']->value;?>
				...
				<?php if ($_smarty_tpl->tpl_vars['show_tax']->value&&isset($_smarty_tpl->tpl_vars['tax_cost']->value)) {?>
					<div id="layer_cart_ajax_cart_tax_cost" class="layer_cart_row hidden">
						<span class="layer_cart_label"><?php echo smartyTranslate(array('s'=>'Tax','mod'=>'blockcart_mod'),$_smarty_tpl);?>
</span>
						<span class="price cart_block_tax_cost ajax_cart_tax_cost"><?php echo $_smarty_tpl->tpl_vars['tax_cost']->value;?>
</span>
					</div>
				...
				<div id="layer_cart_ajax_block_cart_total" class="layer_cart_row">
					<span class="layer_cart_label">
						<?php echo smartyTranslate(array('s'=>'Total','mod'=>'blockcart_mod'),$_smarty_tpl);?>
				...
				<div class="button-container row">
					<div class="col-xxs-12 col-xs-6">
						<span class="continue btn btn-default btn-bootstrap" title="<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart_mod'),$_smarty_tpl);?>
">
							<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart_mod'),$_smarty_tpl);?>
...
" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout','mod'=>'blockcart_mod'),$_smarty_tpl);?>
" rel="nofollow">
							<?php echo smartyTranslate(array('s'=>'Check out','mod'=>'blockcart_mod'),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('cart_size_width'=>intval($_smarty_tpl->tpl_vars['cartSize']->value['width'])),$_smarty_tpl);?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('cart_size_height'=>intval($_smarty_tpl->tpl_vars['cartSize']->value['height'])),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'Customization #','mod'=>'blockcart_mod','js'=>1),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'remove this product from my cart','mod'=>'blockcart_mod','js'=>1),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'Free shipping!','mod'=>'blockcart_mod','js'=>1),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'Free!','mod'=>'blockcart_mod','js'=>1),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'Delete','mod'=>'blockcart_mod','js'=>1),$_smarty_tpl);?>
