...
<section id="featured_products_footer_{$hook_hash}" class="featured_products_footer block col-xs-12 col-sm-3 col-md-3">
    <a href="javascript:;" class="opener visible-xs">&nbsp;</a>
    <h4 class="title_block">{l s='Featured Products' mod='stfeaturedslider'}</h4>
