...
class StOwlCarouselGroup extends ObjectModel
{
    ...
    {
        return Db::getInstance()->executeS('
            SELECT `id_st_owl_carousel_group`,`pag_nav_bg`,`pag_nav_bg_active`,`prev_next_color`,`prev_next_hover`,`prog_bar_color`,`prog_bar_bg`,`prev_next_bg`,`prev_next_bg_hover`
