...
class StOwlCarousel extends Module
{
    ...
    public static $location = array(
        ...
        22 => array('id' =>22 , 'name' => 'Full width Bottom', 'full_width' => 1),
        ...
        if (!$this->isCached('header.tpl', $this->getCacheId()))
        {
            ...
            if (is_array($custom_css_arr) && count($custom_css_arr)) {
                foreach ($custom_css_arr as $v) {
                    ...
                    if($v['text_bg'])
                        $custom_css .= '#st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h1, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h2, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h3, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h4, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h5, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content h6, #st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content p{padding: 0.2em 0.3em;background-color:'.$v['text_bg'].';background-color:rgba('.self::hex2rgb($v['text_bg']).',0.4);}#st_owl_carousel_block_'.$v['id_st_owl_carousel'].' .style_content p{padding: 0.4em 0.6em;}';
                    if($v['btn_color'])
