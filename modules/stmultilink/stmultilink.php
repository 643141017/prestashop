...
class StMultiLink extends Module
{
    ...
    public static $location = array(
        1 => array('id' =>1 , 'name' => 'Top bar right(displayNav)'),
        9 => array('id' =>9 , 'name' => 'Top bar left(displayNavLeft)'),
        2 => array('id' =>2 , 'name' => 'Left column', 'column'=>1),
        4 => array('id' =>4 , 'name' => 'Right column', 'column'=>1),
        24 => array('id' =>24 , 'name' => 'Homepage first quarter'),
        25 => array('id' =>25 , 'name' => 'Homepage second quarter'),
        29 => array('id' =>29 , 'name' => 'Homepage third quarter'),
        30 => array('id' =>30 , 'name' => 'Homepage fourth quarter'),
        7 => array('id' =>7 , 'name' => 'Blog left column', 'column'=>1),
        8 => array('id' =>8 , 'name' => 'Blog right column', 'column'=>1),

        6 => array('id' =>6 , 'name' => 'Footer primary (3/12 wide)'),
        10 => array('id' =>10 , 'name' => 'Footer primary (2/12 wide)'),
        26 => array('id' =>26 , 'name' => 'Footer primary (2.4/12 wide)'),
        11 => array('id' =>11 , 'name' => 'Footer primary (4/12 wide)'),
        12 => array('id' =>12 , 'name' => 'Footer primary (5/12 wide)'),
        13 => array('id' =>13 , 'name' => 'Footer primary (6/12 wide)'),

        3  => array('id' =>3 , 'name' => 'Footer secondary (3/12 wide)'),
        14 => array('id' =>14 , 'name' => 'Footer secondary (2/12 wide)'),
        27 => array('id' =>27 , 'name' => 'Footer secondary (2.4/12 wide)'),
        15 => array('id' =>15 , 'name' => 'Footer secondary (4/12 wide)'),
        16 => array('id' =>16 , 'name' => 'Footer secondary (5/12 wide)'),
        17 => array('id' =>17 , 'name' => 'Footer secondary (6/12 wide)'),

        5 => array('id' =>5 , 'name' => 'Footer tertiary (3/12 wide)'),
        18 => array('id' =>18 , 'name' => 'Footer tertiary (2/12 wide)'),
        28 => array('id' =>28 , 'name' => 'Footer tertiary (2.4/12 wide)'),
        19 => array('id' =>19 , 'name' => 'Footer tertiary (4/12 wide)'),
        20 => array('id' =>20 , 'name' => 'Footer tertiary (5/12 wide)'),
        21 => array('id' =>21 , 'name' => 'Footer tertiary (6/12 wide)'),

        22 => array('id' =>22 , 'name' => 'Footer bottom (Align right)'),
        23 => array('id' =>23 , 'name' => 'Footer bottom (Align left)'),

        31 => array('id' =>31 , 'name' => 'Header top'),
        32 => array('id' =>32 , 'name' => 'Header left'),
        33 => array('id' =>33 , 'name' => 'Header top bottom'),
    );
	...
	public function install()
	{
		$res = parent::install() &&
			...
			$this->registerHook('displayFooterPrimary') &&
            ...
            $this->registerHook('displayHomeFirstQuarter') &&
            $this->registerHook('displayHomeSecondQuarter') &&
            $this->registerHook('displayHomeThirdQuarter') &&
            $this->registerHook('displayHomeFourthQuarter')&&
            $this->registerHook('displayTop')&&
            $this->registerHook('displayHeaderLeft')&&
            $this->registerHook('displayHeaderBottom');
		if ($res)
...
*/
    ...
    public function hookDisplayNav($params)
    {
        if (!$this->isCached('stmultilink-top.tpl', $this->stGetCacheId(1)))
            if(!$this->_prepareHook(1,1))
                return false;
        return $this->display(__FILE__, 'stmultilink-top.tpl', $this->stGetCacheId(1));
    }
    public function hookDisplayNavLeft($params)
    {
        if (!$this->isCached('stmultilink-top.tpl', $this->stGetCacheId(9)))
            if(!$this->_prepareHook(9,1))
                return false;
        return $this->display(__FILE__, 'stmultilink-top.tpl', $this->stGetCacheId(9));
    }
    
    public function hookDisplayTop($params)
    {
        if (!$this->isCached('stmultilink-top.tpl', $this->stGetCacheId(31)))
            if(!$this->_prepareHook(31,1))
                return false;
        return $this->display(__FILE__, 'stmultilink-top.tpl', $this->stGetCacheId(31));
    }
    public function hookDisplayHeaderLeft($params)
    {
        if (!$this->isCached('stmultilink-top.tpl', $this->stGetCacheId(32)))
            if(!$this->_prepareHook(32,1))
                return false;
        return $this->display(__FILE__, 'stmultilink-top.tpl', $this->stGetCacheId(32));
    }
    public function hookDisplayHeaderBottom($params)
    {
        if (!$this->isCached('stmultilink-top.tpl', $this->stGetCacheId(33)))
            if(!$this->_prepareHook(33,1))
                return false;
        return $this->display(__FILE__, 'stmultilink-top.tpl', $this->stGetCacheId(33));
    }
    ...
    {
        if (!$this->isCached('stmultilink.tpl', $this->stGetCacheId(24)))
            if(!$this->_prepareHook(24,1))
                return false;
        return $this->display(__FILE__, 'stmultilink.tpl', $this->stGetCacheId(24));
    }
    public function hookDisplayHomeSecondQuarter($params)
    {
        if (!$this->isCached('stmultilink.tpl', $this->stGetCacheId(25)))
            if(!$this->_prepareHook(25,1))
                return false;
        return $this->display(__FILE__, 'stmultilink.tpl', $this->stGetCacheId(25));
    }

    public function hookDisplayHomeThirdQuarter($params)
    {
        if (!$this->isCached('stmultilink.tpl', $this->stGetCacheId(29)))
            if(!$this->_prepareHook(29,1))
                return false;
        return $this->display(__FILE__, 'stmultilink.tpl', $this->stGetCacheId(29));
    }
    public function hookDisplayHomeFourthQuarter($params)
    {
        if (!$this->isCached('stmultilink.tpl', $this->stGetCacheId(30)))
            if(!$this->_prepareHook(30,1))
                return false;
        return $this->display(__FILE__, 'stmultilink.tpl', $this->stGetCacheId(30));
    }
			...
			'input' => array(
                ...
                'links' => array(
                    ...
                    'options' => array(
						...
						'default' => array(
							'value' => '',
							'label' => $this->l('Select an option or fill up Label')
						),
        			)
				),
                'name' => array(
					'type' => 'text',
					'label' => $this->l('Label / Overwrite name:'),
					'name' => 'name',
                    'lang' => true,
                    'required' => true,
                    'autocomplete' => false,
