...
<ul class="mo_mu_level_0">
	{foreach $stmenu as $mm}
		...
		<li class="mo_ml_level_0">
			<a id="st_mo_ma_{$mm.id_st_mega_menu}" href="{if $mm.m_link}{$mm.m_link|escape:'html':'UTF-8'}{else}javascript:;{/if}" class="mo_ma_level_0"{if !$menu_title} title="{$mm.m_title|escape:'html':'UTF-8'}"{/if}{if $mm.nofollow} rel="nofollow"{/if}>{if $mm.m_icon}{$mm.m_icon}{else}{if $mm.icon_class}<i class="{$mm.icon_class}"></i>{/if}{$mm.m_name|escape:'html':'UTF-8'}{/if}{if $mm.cate_label}<span class="cate_label">{$mm.cate_label}</span>{/if}</a>
					...
					{if isset($column.children) && count($column.children)}
						{foreach $column.children as $block}
							...
							{if $block.item_t==1}
								{if $block.subtype==2  && isset($block.children)}
									<ul class="mo_mu_level_1 mo_sub_ul">
										<li class="mo_ml_level_1 mo_sub_li">
											<a id="st_mo_ma_{$block.id_st_mega_menu}" href="{$block.children.link|escape:'html':'UTF-8'}"{if !$menu_title} title="{$block.children.name|escape:'html':'UTF-8'}"{/if}{if $block.nofollow} rel="nofollow"{/if} class="mo_ma_level_1 mo_sub_a">{$block.children.name|escape:'html':'UTF-8'}{if $block.cate_label}<span class="cate_label">{$block.cate_label}</span>{/if}</a>
											{if isset($block.children.children) && is_array($block.children.children) && count($block.children.children)}
												...
												<li class="mo_ml_level_2 mo_sub_li"><a href="{$product.link|escape:'html':'UTF-8'}"{if !$menu_title} title="{$product.name|escape:'html':'UTF-8'}"{/if}{if $block.nofollow} rel="nofollow"{/if} class="mo_ma_level_2 mo_sub_a">{$product.name|truncate:45:'...'|escape:'html':'UTF-8'}</a></li>
												{/foreach}
												</ul>	
											{/if}
										</li>
								...
								{elseif $block.subtype==0  && isset($block.children.children) && count($block.children.children)}
									{foreach $block.children.children as $menu}
										<ul class="mo_mu_level_1 mo_sub_ul">
											<li class="mo_ml_level_1 mo_sub_li">
												<a href="{$menu.link|escape:'html':'UTF-8'}"{if !$menu_title} title="{$menu.name|escape:'html':'UTF-8'}"{/if}{if $block.nofollow} rel="nofollow"{/if} class="mo_ma_level_1 mo_sub_a">{$menu.name|escape:'html':'UTF-8'}</a>
												{if isset($menu.children) && is_array($menu.children) && count($menu.children)}
													{include file="./stmegamenu-category.tpl" nofollow=$block.nofollow menus=$menu.children m_level=2 ismobilemenu=true}
												{/if}
											</li>
										</ul>	
									{/foreach}
									...
									<ul class="mo_mu_level_1 mo_sub_ul">
										<li class="mo_ml_level_1 mo_sub_li">
    										...
    										{if isset($block.children.children) && count($block.children.children)}
												{include file="./stmegamenu-category.tpl" nofollow=$block.nofollow menus=$block.children.children m_level=2 ismobilemenu=true}
											{/if}
										</li>
									</ul>	
								{/if}
							...
							{elseif $block.item_t==4}
								<ul class="mo_mu_level_1 mo_sub_ul">
									<li class="mo_ml_level_1 mo_sub_li">
										<a  id="st_mo_ma_{$block.id_st_mega_menu}" href="{$block.m_link|escape:'html':'UTF-8'}"{if !$menu_title} title="{$block.m_title|escape:'html':'UTF-8'}"{/if}{if $block.nofollow} rel="nofollow"{/if} class="mo_ma_level_1 mo_sub_a">{$block.m_name|escape:'html':'UTF-8'}{if $block.cate_label}<span class="cate_label">{$block.cate_label}</span>{/if}</a>
										{if isset($block.children) && is_array($block.children) && count($block.children)}
											{foreach $block.children as $menu}
												...
												<span class="opener">&nbsp;</span>
												<ul class="mo_mu_level_2 mo_sub_ul">
												{include file="./stmegamenu-link.tpl" nofollow=$block.nofollow menus=$menu m_level=2 ismobilemenu=true}
												</ul>
											{/foreach}
										{/if}
									</li>
