...
class StMegaMenuClass extends ObjectModel
{
    ...
    {
        return Db::getInstance()->executeS('
            SELECT `id_st_mega_menu`,`item_t`,`txt_color`,`txt_color_over`,`bg_color`,`bg_color_over`,`tab_content_bg`, `bg_image`, `bg_repeat`, `bg_position`, `bg_margin_bottom`, `cate_label_color`, `cate_label_bg`
