...
<section id="st_blog_featured_article" class="block section">
	...
	{foreach $blogs as $blog}
        {if $blog@first}
            <div id="st_blog_featured_article_first" class="block_blog">
            <div class="row">
        ...
        {else}
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 clearfix">
    			...
    			<div class="small_list_right">
    				<h4 class="s_title_block nohidden"><a href="{$blog.link|escape:'html'}" title="{$blog.name|escape:'htmlall':'UTF-8'}">{$blog.name|truncate:30:'...'|escape:html:'UTF-8'}</a></h4>           			      
