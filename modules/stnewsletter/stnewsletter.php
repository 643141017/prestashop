...
class StNewsLetter extends Module
{
    ...
    public static $location = array(
        ...
        53 => array('id' =>53 , 'name' => 'Homepage first quarter'),
        54 => array('id' =>54 , 'name' => 'Homepage second quarter'),
        58 => array('id' =>58 , 'name' => 'Homepage third quarter'),
        59 => array('id' =>59 , 'name' => 'Homepage fourth quarter'),
        35 => array('id' =>35 , 'name' => 'Top column'),
        28 => array('id' =>28 , 'name' => 'Bottom column'),
        37 => array('id' =>37 , 'name' => 'Full width Bottom', 'full_width' => 1),
        2 => array('id' =>2 , 'name' => 'Left column', 'column'=>1),
        10 => array('id' =>10 , 'name' => 'Right column', 'column'=>1),

        13 => array('id' =>13 , 'name' => 'Footer primary (3/12 wide)', 'span' => '3'),
        38 => array('id' =>38 , 'name' => 'Footer primary (2/12 wide)', 'span' => '2'),
        55 => array('id' =>55 , 'name' => 'Footer primary (2.4/12 wide)', 'span' => '2-4'),
        39 => array('id' =>39 , 'name' => 'Footer primary (4/12 wide)', 'span' => '4'),
        40 => array('id' =>40 , 'name' => 'Footer primary (5/12 wide)', 'span' => '5'),
        41 => array('id' =>41 , 'name' => 'Footer primary (6/12 wide)', 'span' => '6'),
        71 => array('id' =>71 , 'name' => 'Footer primary (7/12 wide)', 'span' => '7'),
        72 => array('id' =>72 , 'name' => 'Footer primary (8/12 wide)', 'span' => '8'),
        73 => array('id' =>73 , 'name' => 'Footer primary (9/12 wide)', 'span' => '9'),
        74 => array('id' =>74 , 'name' => 'Footer primary (10/12 wide)', 'span' => '10'),
        42 => array('id' =>42 , 'name' => 'Footer primary (12/12 wide)', 'span' => '12'),

        3  => array('id' =>3 , 'name' => 'Footer secondary (3/12 wide)', 'span' => '3'),
        43 => array('id' =>43 , 'name' => 'Footer secondary (2/12 wide)', 'span' => '2'),
        56 => array('id' =>56 , 'name' => 'Footer secondary (2.4/12 wide)', 'span' => '2-4'),
        44 => array('id' =>44 , 'name' => 'Footer secondary (4/12 wide)', 'span' => '4'),
        45 => array('id' =>45 , 'name' => 'Footer secondary (5/12 wide)', 'span' => '5'),
        46 => array('id' =>46 , 'name' => 'Footer secondary (6/12 wide)', 'span' => '6'),
        81 => array('id' =>81 , 'name' => 'Footer secondary (7/12 wide)', 'span' => '7'),
        82 => array('id' =>82 , 'name' => 'Footer secondary (8/12 wide)', 'span' => '8'),
        83 => array('id' =>83 , 'name' => 'Footer secondary (9/12 wide)', 'span' => '9'),
        84 => array('id' =>84 , 'name' => 'Footer secondary (10/12 wide)', 'span' => '10'),
        47 => array('id' =>47 , 'name' => 'Footer secondary (12/12 wide)', 'span' => '12'),

        12 => array('id' =>12 , 'name' => 'Footer tertiary (3/12 wide)', 'span' => '3'),
        48 => array('id' =>48 , 'name' => 'Footer tertiary (2/12 wide)', 'span' => '2'),
        57 => array('id' =>57 , 'name' => 'Footer tertiary (2.4/12 wide)', 'span' => '2-4'),
        49 => array('id' =>49 , 'name' => 'Footer tertiary (4/12 wide)', 'span' => '4'),
        50 => array('id' =>50 , 'name' => 'Footer tertiary (5/12 wide)', 'span' => '5'),
        51 => array('id' =>51 , 'name' => 'Footer tertiary (6/12 wide)', 'span' => '6'),
        91 => array('id' =>91 , 'name' => 'Footer tertiary (7/12 wide)', 'span' => '7'),
        92 => array('id' =>92 , 'name' => 'Footer tertiary (8/12 wide)', 'span' => '8'),
        93 => array('id' =>93 , 'name' => 'Footer tertiary (9/12 wide)', 'span' => '9'),
        94 => array('id' =>94 , 'name' => 'Footer tertiary (10/12 wide)', 'span' => '10'),
        52 => array('id' =>52 , 'name' => 'Footer tertiary (12/12 wide)', 'span' => '12'),
    );
    ...
    public function sampleData($id_shop)
    {
        ...
        $samples = array(
            array(
                ...
                'show_newsletter' => 1,
                'subscribed'    => 1,
                'text'          => '<label>Sign up today for free and be the first to get notified on our new updates, discounts and special Offers.</label>'
            )
        );
        ...
        if (!$this->isCached('header.tpl', $this->getCacheId()))
        {
            ...
            if(is_array($options) && count($options))
                foreach($options as $v)    
                {
                    ...
                    elseif ($v['bg_pattern'])
                    {
                        $img = _MODULE_DIR_.$this->name.'/patterns/'.$v['bg_pattern'].'.png';
                        $img = $this->context->link->protocol_content.Tools::getMediaServer($img).$img;
                        $group_css .= 'background-image: url('.$img.');';
                    }
                    if($group_css)
    ...
    public function hookDisplayLeftColumn($params)
    {
        if (!$this->isCached('stnewsletter.tpl', $this->stGetCacheId(2)))
            if(!$this->_prepareHook(2))
                return false;
        return $this->display(__FILE__, 'stnewsletter.tpl', $this->stGetCacheId(2));
    }
    ...
    public function hookDisplayRightColumn($params)
    {
        if (!$this->isCached('stnewsletter.tpl', $this->stGetCacheId(10)))
            if(!$this->_prepareHook(10))
                return false;
        return $this->display(__FILE__, 'stnewsletter.tpl', $this->stGetCacheId(10));
    }
