...
class StHomeNew extends Module
{
	...
	function install()
	{
		if (!Configuration::updateValue($this->_prefix_st.'NBR', 8) 
            ...
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_XL', 5)
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_LG', 4)
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_MD', 4)
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_SM', 3)
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_XS', 2)
            || !Configuration::updateValue($this->_prefix_stsn.'HOMENEW_PRO_PER_XXS', 1)
            || !Configuration::updateValue($this->_prefix_st.'TITLE', 1)
            || !Configuration::updateValue($this->_prefix_st.'DIRECTION_NAV', 3)
            || !Configuration::updateValue($this->_prefix_st.'CONTROL_NAV', 1)
        )
			return false;
	...
	public function hookDisplayHome($params, $hook_hash = '', $flag=0)
	{
	    ...
	    if (Configuration::get($this->_prefix_st.'GRID') || !$this->isCached('sthomenew.tpl', $this->stGetCacheId($hook_hash)))
    	{
            ...
            $this->smarty->assign(array(
                ...
                'hook_hash'              => $hook_hash,
                'pro_per_xl'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XL'),
                'pro_per_lg'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_LG'),
                'pro_per_md'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_MD'),
                'pro_per_sm'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_SM'),
                'pro_per_xs'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XS'),
                'pro_per_xxs'       => (int)Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XXS'),
            ));
        }
    ...
    private function getConfigFieldsValues()
    {
        $fields_values = array(
            ...
            'homenew_pro_per_xl'  => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XL'),
            'homenew_pro_per_lg'  => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_LG'),
            'homenew_pro_per_md'  => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_MD'),
            'homenew_pro_per_sm'  => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_SM'),
            'homenew_pro_per_xs'  => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XS'),
            'homenew_pro_per_xxs' => Configuration::get($this->_prefix_stsn.'HOMENEW_PRO_PER_XXS'),
        );
